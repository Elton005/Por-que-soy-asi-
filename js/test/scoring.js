  ...
  getProfile(key) {
    const profiles = {
      impulsivo_entusiasta: {
        ...
        icon: 'fa-bolt-lightning', // Rayo (energía),
        ...
        recomendacion: 'Tu entusiasmo no es un defecto, es tu fortaleza. El crecimiento está en aprender a sostener un poco más aquello que realmente importa, incluso cuando deja de sentirse emocionante. Pregúntate: ¿Voy a poder sostener esto cuando la emoción inicial baje?',
      ...
      lider_intenso: {
        ...
        icon: 'fa-crown', // Corona (liderazgo)
        ...
        recomendacion: 'Ser fuerte no significa cargar con todo ni tener siempre la razón. El crecimiento está en equilibrar tu firmeza con empatía. Antes de actuar, pregúntate: ¿Cómo puede sentirse la otra persona con la manera en que estoy diciendo esto?',
      ...
      observador_tranquilo: {
        ...
        icon: 'fa-leaf', // Hoja (calma, naturaleza)
      ...
      profundo_autoexigente: {
        ...
        recomendacion: 'No todo en la vida necesita estar completamente resuelto para poder empezar. El crecimiento está en aprender a ser un poco más amable contigo mismo. Recuerda: "suficientemente bueno" también puede ser suficiente.',
      ...
      precavido_silencioso: {
        ...
        icon: 'fa-shield-halved', // Escudo (protección, cautela)
        ...
        recomendacion: 'Evitar algo no siempre lo resuelve, a veces solo lo aplaza. El crecimiento está en aprender a decir lo que sientes un poco antes, expresar una incomodidad con calma o entender que poner límites también puede ser una forma de cuidar una relación.',
      ...
      reactivo_emocional: {
        ...
        icon: 'fa-fire-flame-curved', // Fuego (intensidad emocional)
        ...
        recomendacion: 'Sentir mucho no es el problema. El verdadero reto está en aprender a darte un poco más de tiempo antes de reaccionar. Una emoción intensa no siempre necesita una respuesta inmediata, a veces solo necesita unos minutos para bajar el volumen.',
      ...
      disciplinado_construccion: {
        ...
        icon: 'fa-hammer', // Martillo (construcción, trabajo)
      ...
      autocritico_exigente: {
        ...
        icon: 'fa-scale-balanced', // Balanza (juicio, equilibrio)
        ...
        recomendacion: 'Tu valor como persona no depende únicamente de lo que logras. El crecimiento está en aprender a relacionarte contigo mismo de una manera más amable. Hay una diferencia importante entre querer crecer… y vivir sintiendo que nunca eres suficiente.',
      ...
      adaptativo_flexible: {
        ...
        icon: 'fa-wind', // Viento (adaptabilidad)
        ...
        recomendacion: 'Adaptarte es una fortaleza, pero no cuando el precio termina siendo olvidarte demasiado de ti mismo. El crecimiento está en aprender a ocupar un poco más de espacio dentro de tu propia vida. Cuidar a otros tiene valor, pero aprender a no desaparecerte mientras lo haces también.',
      ...
      analitico_reservado: {
        ...
        icon: 'fa-brain', // Cerebro (análisis, pensamiento)
        ...
        recomendacion: 'La claridad absoluta casi nunca llega, y muchas veces la seguridad aparece después de empezar, no antes. El crecimiento está en confiar para actuar incluso cuando no todo está completamente resuelto.',
      ...
      resiliente_consciente: {
        ...
        icon: 'fa-tree', // Árbol (resiliencia, crecimiento)
        ...
        recomendacion: 'Ser fuerte no significa tener que sostener todo solo. El crecimiento no consiste en resistir más, sino en aprender a compartir un poco del peso. Permitirte descansar. Hablar cuando algo duele. Pedir ayuda sin sentir que eso te hace menos capaz.',
      ...
      integrado_intencional: {
        ...
        icon: 'fa-compass', // Brújula (dirección, conciencia)
